    ...
    public List<Map<Move, State>> getSolution() {
        ...
        if (hasSolution) {
            if (foundSolution) {
                ...
                System.out.println(strategyName+" strategy was not able to find a solution after generating all states using " + maxNrMoves + " transitions/moves from the initial state");
            }
        } else {
            System.out.println("The initial state from which we started doesn't have a solution");
        }
